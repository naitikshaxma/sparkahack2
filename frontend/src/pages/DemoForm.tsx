      ...
      <div className="max-w-xl mx-auto bg-[#111111] border border-[#2a2a2a] rounded-2xl p-6 md:p-8">
        ...
        <form className="space-y-4">
          <div>
            ...
            <input id="fullName" type="text" className="w-full rounded-xl bg-[#171717] border border-[#2a2a2a] px-4 py-3 outline-none focus:border-[#f59e0b]" />
          </div>

          <div>
            <label htmlFor="phone" className="block text-sm mb-1 text-[#9ca3af]">Phone</label>
            <input id="phone" type="text" className="w-full rounded-xl bg-[#171717] border border-[#2a2a2a] px-4 py-3 outline-none focus:border-[#f59e0b]" />
          </div>

          <div>
            <label htmlFor="aadhaar" className="block text-sm mb-1 text-[#9ca3af]">Aadhaar</label>
            <input id="aadhaar" type="text" className="w-full rounded-xl bg-[#171717] border border-[#2a2a2a] px-4 py-3 outline-none focus:border-[#f59e0b]" />
          </div>

          <div>
            <label htmlFor="income" className="block text-sm mb-1 text-[#9ca3af]">Income</label>
            <input id="income" type="text" className="w-full rounded-xl bg-[#171717] border border-[#2a2a2a] px-4 py-3 outline-none focus:border-[#f59e0b]" />
          </div>
